...
// the private key.
OPENSSL_EXPORT void KYBER_generate_key(uint8_t out_encoded_public_key[KYBER_PUBLIC_KEY_BYTES],
...
OPENSSL_EXPORT void KYBER_public_from_private(struct KYBER_public_key* out_public_key,
...
// failure.
OPENSSL_EXPORT void KYBER_decap(uint8_t out_shared_secret[KYBER_SHARED_SECRET_BYTES],
...
// error.
OPENSSL_EXPORT int KYBER_marshal_public_key(CBB* out, const struct KYBER_public_key* public_key);
...
OPENSSL_EXPORT int KYBER_parse_public_key(struct KYBER_public_key* out_public_key, CBS* in);
...
// allocation error.
OPENSSL_EXPORT int KYBER_marshal_private_key(CBB* out, const struct KYBER_private_key* private_key);
...
// there are trailing bytes in |in|.
OPENSSL_EXPORT int KYBER_parse_private_key(struct KYBER_private_key* out_private_key, CBS* in);
