...
OPENSSL_EXPORT int EVP_DecodeBase64(uint8_t* out, size_t* out_len, size_t max_out,
...
OPENSSL_EXPORT void EVP_EncodeUpdate(EVP_ENCODE_CTX* ctx, uint8_t* out, int* out_len,
                                     const uint8_t* in, size_t in_len);
...
OPENSSL_EXPORT int EVP_DecodeUpdate(EVP_ENCODE_CTX* ctx, uint8_t* out, int* out_len,
                                    const uint8_t* in, size_t in_len);
