...
OPENSSL_EXPORT void DSA_get0_pqg(const DSA* dsa, const BIGNUM** out_p, const BIGNUM** out_q,
                                 const BIGNUM** out_g);
...
OPENSSL_EXPORT int DSA_generate_parameters_ex(DSA* dsa, unsigned bits, const uint8_t* seed,
...
//
// TODO(fork): deprecate.
OPENSSL_EXPORT int DSA_do_verify(const uint8_t* digest, size_t digest_len, const DSA_SIG* sig,
                                 const DSA* dsa);
...
// and zero on error.
OPENSSL_EXPORT int DSA_do_check_signature(int* out_valid, const uint8_t* digest, size_t digest_len,
...
//
// TODO(fork): deprecate.
OPENSSL_EXPORT int DSA_verify(int type, const uint8_t* digest, size_t digest_len,
...
// It returns one if it was able to verify the signature as valid or invalid,
// and zero on error.
OPENSSL_EXPORT int DSA_check_signature(int* out_valid, const uint8_t* digest, size_t digest_len,
                                       const uint8_t* sig, size_t sig_len, const DSA* dsa);
...
OPENSSL_EXPORT int DSA_get_ex_new_index(long argl, void* argp, CRYPTO_EX_unused* unused,
...
// it.
OPENSSL_EXPORT DSA* DSA_generate_parameters(int bits, unsigned char* seed, int seed_len,
