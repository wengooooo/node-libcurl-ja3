...
OPENSSL_EXPORT int CBS_get_any_asn1_element(CBS* cbs, CBS* out, CBS_ASN1_TAG* out_tag,
...
// separately.
OPENSSL_EXPORT int CBS_get_any_ber_asn1_element(CBS* cbs, CBS* out, CBS_ASN1_TAG* out_tag,
...
OPENSSL_EXPORT int CBS_get_asn1_uint64_with_tag(CBS* cbs, uint64_t* out, CBS_ASN1_TAG tag);
...
// bits.
OPENSSL_EXPORT int CBS_get_asn1_int64_with_tag(CBS* cbs, int64_t* out, CBS_ASN1_TAG tag);
...
OPENSSL_EXPORT int CBS_get_optional_asn1_octet_string(CBS* cbs, CBS* out, int* out_present,
                                                      CBS_ASN1_TAG tag);
...
// decode failure.
OPENSSL_EXPORT int CBS_get_optional_asn1_uint64(CBS* cbs, uint64_t* out, CBS_ASN1_TAG tag,
...
// failure.
OPENSSL_EXPORT int CBS_get_optional_asn1_bool(CBS* cbs, int* out, CBS_ASN1_TAG tag,
                                              int default_value);
