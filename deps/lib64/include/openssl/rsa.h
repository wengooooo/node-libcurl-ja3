...
OPENSSL_EXPORT RSA* RSA_new_private_key(const BIGNUM* n, const BIGNUM* e, const BIGNUM* d,
...
OPENSSL_EXPORT void RSA_get0_key(const RSA* rsa, const BIGNUM** out_n, const BIGNUM** out_e,
                                 const BIGNUM** out_d);
...
OPENSSL_EXPORT int RSA_encrypt(RSA* rsa, size_t* out_len, uint8_t* out, size_t max_out,
...
OPENSSL_EXPORT int RSA_decrypt(RSA* rsa, size_t* out_len, uint8_t* out, size_t max_out,
                               const uint8_t* in, size_t in_len, int padding);
...
OPENSSL_EXPORT int RSA_public_encrypt(size_t flen, const uint8_t* from, uint8_t* to, RSA* rsa,
                                      int padding);
...
OPENSSL_EXPORT int RSA_private_decrypt(size_t flen, const uint8_t* from, uint8_t* to, RSA* rsa,
                                       int padding);
...
// scheme.
OPENSSL_EXPORT int RSA_sign(int hash_nid, const uint8_t* digest, size_t digest_len, uint8_t* out,
...
OPENSSL_EXPORT int RSA_sign_pss_mgf1(RSA* rsa, size_t* out_len, uint8_t* out, size_t max_out,
...
OPENSSL_EXPORT int RSA_sign_raw(RSA* rsa, size_t* out_len, uint8_t* out, size_t max_out,
                                const uint8_t* in, size_t in_len, int padding);
...
// scheme.
OPENSSL_EXPORT int RSA_verify(int hash_nid, const uint8_t* digest, size_t digest_len,
...
OPENSSL_EXPORT int RSA_verify_pss_mgf1(RSA* rsa, const uint8_t* digest, size_t digest_len,
...
OPENSSL_EXPORT int RSA_verify_raw(RSA* rsa, size_t* out_len, uint8_t* out, size_t max_out,
                                  const uint8_t* in, size_t in_len, int padding);
...
OPENSSL_EXPORT int RSA_private_encrypt(size_t flen, const uint8_t* from, uint8_t* to, RSA* rsa,
                                       int padding);
...
OPENSSL_EXPORT int RSA_public_decrypt(size_t flen, const uint8_t* from, uint8_t* to, RSA* rsa,
                                      int padding);
...
OPENSSL_EXPORT int RSA_verify_PKCS1_PSS_mgf1(const RSA* rsa, const uint8_t* mHash,
...
OPENSSL_EXPORT int RSA_padding_add_PKCS1_PSS_mgf1(const RSA* rsa, uint8_t* EM, const uint8_t* mHash,
                                                  const EVP_MD* Hash, const EVP_MD* mgf1Hash,
                                                  int sLen);
...
//
// It returns one on success or zero on error.
OPENSSL_EXPORT int RSA_padding_add_PKCS1_OAEP_mgf1(uint8_t* to, size_t to_len, const uint8_t* from,
...
OPENSSL_EXPORT int RSA_add_pkcs1_prefix(uint8_t** out_msg, size_t* out_msg_len, int* is_alloced,
                                        int hash_nid, const uint8_t* digest, size_t digest_len);
...
// serialized.
OPENSSL_EXPORT RSA* RSA_new_private_key_no_crt(const BIGNUM* n, const BIGNUM* e, const BIGNUM* d);
...
OPENSSL_EXPORT RSA* RSA_new_public_key_large_e(const BIGNUM* n, const BIGNUM* e);
...
OPENSSL_EXPORT RSA* RSA_new_private_key_large_e(const BIGNUM* n, const BIGNUM* e, const BIGNUM* d,
...
OPENSSL_EXPORT int RSA_get_ex_new_index(long argl, void* argp, CRYPTO_EX_unused* unused,
...
OPENSSL_EXPORT RSA* RSA_generate_key(int bits, uint64_t e, void* callback, void* cb_arg);
...
// This function implements only the low-level padding logic. Use
// |RSA_sign_pss_mgf1| instead.
OPENSSL_EXPORT int RSA_padding_add_PKCS1_PSS(const RSA* rsa, uint8_t* EM, const uint8_t* mHash,
...
// This function implements only the low-level padding logic. Use
// |RSA_verify_pss_mgf1| instead.
OPENSSL_EXPORT int RSA_verify_PKCS1_PSS(const RSA* rsa, const uint8_t* mHash, const EVP_MD* Hash,
                                        const uint8_t* EM, int sLen);
...
// which means SHA-1.
OPENSSL_EXPORT int RSA_padding_add_PKCS1_OAEP(uint8_t* to, size_t to_len, const uint8_t* from,
                                              size_t from_len, const uint8_t* param,
                                              size_t param_len);
