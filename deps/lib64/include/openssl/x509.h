...
OPENSSL_EXPORT void X509_get0_uids(const X509* x509, const ASN1_BIT_STRING** out_issuer_uid,
...
// verifying.
OPENSSL_EXPORT void X509_get0_signature(const ASN1_BIT_STRING** out_sig, const X509_ALGOR** out_alg,
                                        const X509* x509);
...
OPENSSL_EXPORT X509* d2i_X509_AUX(X509** x509, const uint8_t** inp, long length);
...
// alias.
OPENSSL_EXPORT int X509_alias_set1(X509* x509, const uint8_t* name, ossl_ssize_t len);
...
OPENSSL_EXPORT int X509_keyid_set1(X509* x509, const uint8_t* id, ossl_ssize_t len);
...
OPENSSL_EXPORT int X509_CRL_get0_by_cert(X509_CRL* crl, X509_REVOKED** out, X509* x509);
...
// WARNING: This function is difficult to use correctly. See the documentation
// for |X509V3_get_d2i| for details.
OPENSSL_EXPORT void* X509_CRL_get_ext_d2i(const X509_CRL* crl, int nid, int* out_critical,
                                          int* out_idx);
...
OPENSSL_EXPORT void X509_CRL_get0_signature(const X509_CRL* crl, const ASN1_BIT_STRING** out_sig,
...
OPENSSL_EXPORT X509_REVOKED* d2i_X509_REVOKED(X509_REVOKED** out, const uint8_t** inp, long len);
...
// for extensions in |x|.
OPENSSL_EXPORT int X509_REVOKED_get_ext_by_OBJ(const X509_REVOKED* x, const ASN1_OBJECT* obj,
                                               int lastpos);
...
// WARNING: This function is difficult to use correctly. See the documentation
// for |X509V3_get_d2i| for details.
OPENSSL_EXPORT void* X509_REVOKED_get_ext_d2i(const X509_REVOKED* revoked, int nid,
...
// and zero otherwise.
OPENSSL_EXPORT int X509_REQ_check_private_key(const X509_REQ* req, const EVP_PKEY* pkey);
...
OPENSSL_EXPORT int X509_REQ_get_attr_by_OBJ(const X509_REQ* req, const ASN1_OBJECT* obj,
                                            int lastpos);
...
OPENSSL_EXPORT STACK_OF(X509_EXTENSION) * X509_REQ_get_extensions(const X509_REQ* req);
...
// to ignore the value.
OPENSSL_EXPORT void X509_REQ_get0_signature(const X509_REQ* req, const ASN1_BIT_STRING** out_sig,
                                            const X509_ALGOR** out_alg);
...
// On error, or if there are no such email addresses, it returns NULL. When
// done, the caller must release the result with |X509_email_free|.
OPENSSL_EXPORT STACK_OF(OPENSSL_STRING) * X509_REQ_get1_email(const X509_REQ* req);
...
// returns one on success and zero on error.
OPENSSL_EXPORT int X509_REQ_add1_attr(X509_REQ* req, const X509_ATTRIBUTE* attr);
...
OPENSSL_EXPORT int X509_REQ_add1_attr_by_OBJ(X509_REQ* req, const ASN1_OBJECT* obj, int attrtype,
                                             const unsigned char* data, int len);

// X509_REQ_add1_attr_by_NID behaves like |X509_REQ_add1_attr_by_OBJ| except the
// attribute type is determined by |nid|.
OPENSSL_EXPORT int X509_REQ_add1_attr_by_NID(X509_REQ* req, int nid, int attrtype,
                                             const unsigned char* data, int len);
...
OPENSSL_EXPORT int X509_REQ_add1_attr_by_txt(X509_REQ* req, const char* attrname, int attrtype,
                                             const unsigned char* data, int len);
...
OPENSSL_EXPORT int X509_REQ_add_extensions_nid(X509_REQ* req, const STACK_OF(X509_EXTENSION) * exts,
                                               int nid);
...
OPENSSL_EXPORT int X509_NAME_get_index_by_OBJ(const X509_NAME* name, const ASN1_OBJECT* obj,
                                              int lastpos);
...
// This function will internally update RDN indices (see |X509_NAME_ENTRY_set|)
// so they continue to be consecutive.
OPENSSL_EXPORT int X509_NAME_add_entry(X509_NAME* name, const X509_NAME_ENTRY* entry, int loc,
                                       int set);
...
OPENSSL_EXPORT int X509_NAME_add_entry_by_OBJ(X509_NAME* name, const ASN1_OBJECT* obj, int type,
                                              const uint8_t* bytes, ossl_ssize_t len, int loc,
                                              int set);
...
OPENSSL_EXPORT int X509_NAME_ENTRY_set_data(X509_NAME_ENTRY* entry, int type, const uint8_t* bytes,
                                            ossl_ssize_t len);
...
OPENSSL_EXPORT X509_NAME_ENTRY* X509_NAME_ENTRY_create_by_OBJ(X509_NAME_ENTRY** out,
...
// constants.
OPENSSL_EXPORT X509_NAME_ENTRY* X509_NAME_ENTRY_create_by_NID(X509_NAME_ENTRY** out, int nid,
...
OPENSSL_EXPORT X509_NAME_ENTRY* X509_NAME_ENTRY_create_by_txt(X509_NAME_ENTRY** out,
...
OPENSSL_EXPORT X509_PUBKEY* d2i_X509_PUBKEY(X509_PUBKEY** out, const uint8_t** inp, long len);
...
OPENSSL_EXPORT int X509_PUBKEY_set0_param(X509_PUBKEY* pub, ASN1_OBJECT* obj, int param_type,
...
OPENSSL_EXPORT int X509_PUBKEY_get0_param(ASN1_OBJECT** out_obj, const uint8_t** out_key,
                                          int* out_key_len, X509_ALGOR** out_alg, X509_PUBKEY* pub);
...
OPENSSL_EXPORT X509_EXTENSION* d2i_X509_EXTENSION(X509_EXTENSION** out, const uint8_t** inp,
                                                  long len);
...
OPENSSL_EXPORT X509_EXTENSIONS* d2i_X509_EXTENSIONS(X509_EXTENSIONS** out, const uint8_t** inp,
                                                    long len);
...
OPENSSL_EXPORT int X509v3_get_ext_by_OBJ(const STACK_OF(X509_EXTENSION) * x, const ASN1_OBJECT* obj,
                                         int lastpos);
...
// can thus loop over all matching extensions by first passing -1 and then
// passing the previously-returned value until no match is returned.
OPENSSL_EXPORT int X509v3_get_ext_by_critical(const STACK_OF(X509_EXTENSION) * x, int crit,
                                              int lastpos);
...
OPENSSL_EXPORT STACK_OF(X509_EXTENSION) *
    X509v3_add_ext(STACK_OF(X509_EXTENSION) * *x, const X509_EXTENSION* ex, int loc);
...
OPENSSL_EXPORT void* X509V3_get_d2i(const STACK_OF(X509_EXTENSION) * extensions, int nid,
                                    int* out_critical, int* out_idx);
...
// list at the top of this section for the correct types.
OPENSSL_EXPORT int X509V3_add1_i2d(STACK_OF(X509_EXTENSION) * *x, int nid, void* value, int crit,
                                   unsigned long flags);
...
// 5280), as described in |i2d_SAMPLE|.
OPENSSL_EXPORT int i2d_BASIC_CONSTRAINTS(const BASIC_CONSTRAINTS* bcons, uint8_t** outp);
...
OPENSSL_EXPORT EXTENDED_KEY_USAGE* d2i_EXTENDED_KEY_USAGE(EXTENDED_KEY_USAGE** out,
                                                          const uint8_t** inp, long len);

// i2d_EXTENDED_KEY_USAGE marshals |eku| as a DER-encoded ExtKeyUsageSyntax (RFC
// 5280), as described in |i2d_SAMPLE|.
OPENSSL_EXPORT int i2d_EXTENDED_KEY_USAGE(const EXTENDED_KEY_USAGE* eku, uint8_t** outp);
...
OPENSSL_EXPORT GENERAL_NAME* d2i_GENERAL_NAME(GENERAL_NAME** out, const uint8_t** inp, long len);
...
OPENSSL_EXPORT GENERAL_NAMES* d2i_GENERAL_NAMES(GENERAL_NAMES** out, const uint8_t** inp, long len);
...
OPENSSL_EXPORT void GENERAL_NAME_set0_value(GENERAL_NAME* gen, int type, void* value);
...
OPENSSL_EXPORT void* GENERAL_NAME_get0_value(const GENERAL_NAME* gen, int* out_type);
...
OPENSSL_EXPORT int GENERAL_NAME_set0_othername(GENERAL_NAME* gen, ASN1_OBJECT* oid,
                                               ASN1_TYPE* value);
...
OPENSSL_EXPORT int GENERAL_NAME_get0_otherName(const GENERAL_NAME* gen, ASN1_OBJECT** out_oid,
                                               ASN1_TYPE** out_value);
...
OPENSSL_EXPORT AUTHORITY_KEYID* d2i_AUTHORITY_KEYID(AUTHORITY_KEYID** out, const uint8_t** inp,
                                                    long len);
...
// |d2i_SAMPLE|.
OPENSSL_EXPORT AUTHORITY_INFO_ACCESS* d2i_AUTHORITY_INFO_ACCESS(AUTHORITY_INFO_ACCESS** out,
                                                                const uint8_t** inp, long len);
...
// contains an |X509_NAME|.
OPENSSL_EXPORT int i2d_AUTHORITY_INFO_ACCESS(AUTHORITY_INFO_ACCESS* aia, uint8_t** outp);
...
OPENSSL_EXPORT CRL_DIST_POINTS* d2i_CRL_DIST_POINTS(CRL_DIST_POINTS** out, const uint8_t** inp,
                                                    long len);
...
OPENSSL_EXPORT ISSUING_DIST_POINT* d2i_ISSUING_DIST_POINT(ISSUING_DIST_POINT** out,
                                                          const uint8_t** inp, long len);
...
// contains an |X509_NAME|.
OPENSSL_EXPORT int i2d_ISSUING_DIST_POINT(ISSUING_DIST_POINT* idp, uint8_t** outp);
...
OPENSSL_EXPORT CERTIFICATEPOLICIES* d2i_CERTIFICATEPOLICIES(CERTIFICATEPOLICIES** out,
                                                            const uint8_t** inp, long len);

// i2d_CERTIFICATEPOLICIES marshals |policies| as a DER-encoded
// CertificatePolicies (RFC 5280), as described in |i2d_SAMPLE|.
OPENSSL_EXPORT int i2d_CERTIFICATEPOLICIES(const CERTIFICATEPOLICIES* policies, uint8_t** outp);
...
OPENSSL_EXPORT int X509_ALGOR_set0(X509_ALGOR* alg, ASN1_OBJECT* obj, int param_type,
                                   void* param_value);
...
OPENSSL_EXPORT void X509_ALGOR_get0(const ASN1_OBJECT** out_obj, int* out_param_type,
...
OPENSSL_EXPORT X509_ATTRIBUTE* d2i_X509_ATTRIBUTE(X509_ATTRIBUTE** out, const uint8_t** inp,
                                                  long len);

// i2d_X509_ATTRIBUTE marshals |alg| as a DER-encoded Attribute (RFC 2986), as
// described in |i2d_SAMPLE|.
OPENSSL_EXPORT int i2d_X509_ATTRIBUTE(const X509_ATTRIBUTE* alg, uint8_t** outp);
...
OPENSSL_EXPORT int X509_ATTRIBUTE_set1_data(X509_ATTRIBUTE* attr, int attrtype, const void* data,
                                            int len);
...
OPENSSL_EXPORT void* X509_ATTRIBUTE_get0_data(X509_ATTRIBUTE* attr, int idx, int attrtype,
                                              void* unused);
...
OPENSSL_EXPORT int X509_STORE_set1_param(X509_STORE* store, const X509_VERIFY_PARAM* param);
...
OPENSSL_EXPORT STACK_OF(X509_OBJECT) * X509_STORE_get1_objects(X509_STORE* store);
...
// verification.
OPENSSL_EXPORT int X509_STORE_CTX_init(X509_STORE_CTX* ctx, X509_STORE* store, X509* x509,
                                       STACK_OF(X509) * chain);
...
// details.
OPENSSL_EXPORT STACK_OF(X509) * X509_STORE_CTX_get0_chain(const X509_STORE_CTX* ctx);
...
OPENSSL_EXPORT STACK_OF(X509) * X509_STORE_CTX_get1_chain(const X509_STORE_CTX* ctx);
...
OPENSSL_EXPORT X509_CRL* X509_STORE_CTX_get0_current_crl(const X509_STORE_CTX* ctx);
...
OPENSSL_EXPORT STACK_OF(X509) * X509_STORE_CTX_get0_untrusted(const X509_STORE_CTX* ctx);
...
// take ownership of its input. The caller is required to ensure the lifetimes
// are consistent.
OPENSSL_EXPORT void X509_STORE_CTX_set0_crls(X509_STORE_CTX* ctx, STACK_OF(X509_CRL) * sk);
...
OPENSSL_EXPORT void X509_STORE_CTX_set_time_posix(X509_STORE_CTX* ctx, unsigned long flags,
                                                  int64_t t);
...
OPENSSL_EXPORT unsigned long X509_VERIFY_PARAM_get_flags(const X509_VERIFY_PARAM* param);
...
// seconds.
OPENSSL_EXPORT void X509_VERIFY_PARAM_set_time_posix(X509_VERIFY_PARAM* param, int64_t t);
...
OPENSSL_EXPORT int X509_VERIFY_PARAM_set1_host(X509_VERIFY_PARAM* param, const char* name,
                                               size_t name_len);
...
// |X509_CHECK_FLAG_NEVER_CHECK_SUBJECT| to use the standard behavior.
// https://crbug.com/boringssl/464 tracks fixing the default.
OPENSSL_EXPORT int X509_VERIFY_PARAM_add1_host(X509_VERIFY_PARAM* param, const char* name,
                                               size_t name_len);
...
OPENSSL_EXPORT int X509_VERIFY_PARAM_set1_email(X509_VERIFY_PARAM* param, const char* email,
                                                size_t email_len);
...
OPENSSL_EXPORT int X509_VERIFY_PARAM_set1_ip(X509_VERIFY_PARAM* param, const uint8_t* ip,
                                             size_t ip_len);
...
OPENSSL_EXPORT int X509_STORE_load_locations(X509_STORE* store, const char* file, const char* dir);
...
OPENSSL_EXPORT X509_LOOKUP* X509_STORE_add_lookup(X509_STORE* store,
...
OPENSSL_EXPORT int X509_LOOKUP_load_file(X509_LOOKUP* lookup, const char* file, int type);
...
OPENSSL_EXPORT int X509_LOOKUP_add_dir(X509_LOOKUP* lookup, const char* path, int type);
...
OPENSSL_EXPORT int X509_LOOKUP_ctrl(X509_LOOKUP* lookup, int cmd, const char* argc, long argl,
                                    char** ret);
...
OPENSSL_EXPORT int X509_load_cert_file(X509_LOOKUP* lookup, const char* file, int type);
...
OPENSSL_EXPORT int X509_load_crl_file(X509_LOOKUP* lookup, const char* file, int type);
...
OPENSSL_EXPORT int X509_load_cert_crl_file(X509_LOOKUP* lookup, const char* file, int type);
...
OPENSSL_EXPORT NETSCAPE_SPKI* d2i_NETSCAPE_SPKI(NETSCAPE_SPKI** out, const uint8_t** inp, long len);
...
OPENSSL_EXPORT NETSCAPE_SPKI* NETSCAPE_SPKI_b64_decode(const char* str, ossl_ssize_t len);
...
OPENSSL_EXPORT NETSCAPE_SPKAC* d2i_NETSCAPE_SPKAC(NETSCAPE_SPKAC** out, const uint8_t** inp,
                                                  long len);

// i2d_NETSCAPE_SPKAC marshals |spkac| as a DER-encoded PublicKeyAndChallenge
// structure, as described in |i2d_SAMPLE|.
OPENSSL_EXPORT int i2d_NETSCAPE_SPKAC(const NETSCAPE_SPKAC* spkac, uint8_t** outp);
...
OPENSSL_EXPORT RSA_PSS_PARAMS* d2i_RSA_PSS_PARAMS(RSA_PSS_PARAMS** out, const uint8_t** inp,
                                                  long len);
...
OPENSSL_EXPORT PKCS8_PRIV_KEY_INFO* d2i_PKCS8_PRIV_KEY_INFO(PKCS8_PRIV_KEY_INFO** out,
                                                            const uint8_t** inp, long len);

// i2d_PKCS8_PRIV_KEY_INFO marshals |key| as a DER-encoded PrivateKeyInfo, as
// described in |i2d_SAMPLE|.
OPENSSL_EXPORT int i2d_PKCS8_PRIV_KEY_INFO(const PKCS8_PRIV_KEY_INFO* key, uint8_t** outp);
...
OPENSSL_EXPORT X509_SIG* d2i_X509_SIG(X509_SIG** out, const uint8_t** inp, long len);
...
OPENSSL_EXPORT void X509_SIG_get0(const X509_SIG* sig, const X509_ALGOR** out_alg,
...
OPENSSL_EXPORT int X509_print_ex_fp(FILE* fp, X509* x, unsigned long nmflag, unsigned long cflag);
...
OPENSSL_EXPORT int X509_NAME_print_ex_fp(FILE* fp, const X509_NAME* nm, int indent,
                                         unsigned long flags);
...
// or logging.
OPENSSL_EXPORT int X509V3_EXT_print(BIO* out, const X509_EXTENSION* ext, unsigned long flag,
                                    int indent);
...
// purposes.
OPENSSL_EXPORT int X509_pubkey_digest(const X509* x509, const EVP_MD* md, uint8_t* out,
                                      unsigned* out_len);
...
OPENSSL_EXPORT int X509_CRL_digest(const X509_CRL* crl, const EVP_MD* md, uint8_t* out,
                                   unsigned* out_len);
...
// portion.
OPENSSL_EXPORT int X509_REQ_digest(const X509_REQ* req, const EVP_MD* md, uint8_t* out,
                                   unsigned* out_len);
...
// |EVP_MAX_MD_SIZE|. If |out_len| is not NULL, |*out_len| is set to the number
// of bytes written. This function returns one on success and zero on error.
OPENSSL_EXPORT int X509_NAME_digest(const X509_NAME* name, const EVP_MD* md, uint8_t* out,
                                    unsigned* out_len);
...
// returns NULL.
OPENSSL_EXPORT X509* X509_find_by_issuer_and_serial(const STACK_OF(X509) * sk, X509_NAME* name,
                                                    const ASN1_INTEGER* serial);
...
OPENSSL_EXPORT ASN1_TIME* X509_time_adj(ASN1_TIME* s, long offset_sec, const time_t* t);

// X509_time_adj_ex behaves like |ASN1_TIME_adj|, but adds an offset to |*t|. If
// |t| is NULL, it uses the current time instead of |*t|.
OPENSSL_EXPORT ASN1_TIME* X509_time_adj_ex(ASN1_TIME* s, int offset_day, long offset_sec,
                                           const time_t* t);
...
OPENSSL_EXPORT int ASN1_digest(i2d_of_void* i2d, const EVP_MD* type, char* data, unsigned char* md,
                               unsigned int* len);
...
// WARNING: |data| must be a pointer with the same type as |it|'s corresponding
// C type. Using the wrong type is a potentially exploitable memory error.
OPENSSL_EXPORT int ASN1_item_verify(const ASN1_ITEM* it, const X509_ALGOR* algor1,
                                    const ASN1_BIT_STRING* signature, void* data, EVP_PKEY* pkey);
...
OPENSSL_EXPORT int X509_check_host(const X509* x509, const char* chk, size_t chklen,
                                   unsigned int flags, char** out_peername);
...
//
// TODO(davidben): Make the error case also return zero.
OPENSSL_EXPORT int X509_check_email(const X509* x509, const char* chk, size_t chklen,
                                    unsigned int flags);
...
//
// TODO(davidben): Make the error case also return zero.
OPENSSL_EXPORT int X509_check_ip(const X509* x509, const uint8_t* chk, size_t chklen,
                                 unsigned int flags);
...
//
// TODO(davidben): Make the error case also return zero.
OPENSSL_EXPORT int X509_check_ip_asc(const X509* x509, const char* ipasc, unsigned int flags);
...
//
// TODO(crbug.com/boringssl/407): |x509| should be const.
OPENSSL_EXPORT int X509_STORE_CTX_get1_issuer(X509** out_issuer, X509_STORE_CTX* ctx, X509* x509);
...
OPENSSL_EXPORT STACK_OF(X509) * X509_STORE_CTX_get1_certs(X509_STORE_CTX* ctx, X509_NAME* name);
...
//
// TODO(crbug.com/boringssl/407): |name| should be const.
OPENSSL_EXPORT STACK_OF(X509_CRL) * X509_STORE_CTX_get1_crls(X509_STORE_CTX* ctx, X509_NAME* name);
...
//
// TODO(crbug.com/boringssl/407): |name| should be const.
OPENSSL_EXPORT int X509_STORE_CTX_get_by_subject(X509_STORE_CTX* ctx, int type, X509_NAME* name,
                                                 X509_OBJECT* ret);
...
typedef STACK_OF(CONF_VALUE) *
    (*X509V3_EXT_I2V)(const X509V3_EXT_METHOD* method, void* ext, STACK_OF(CONF_VALUE) * extlist);
typedef void* (*X509V3_EXT_V2I)(const X509V3_EXT_METHOD* method, const X509V3_CTX* ctx,
                                const STACK_OF(CONF_VALUE) * values);
typedef char* (*X509V3_EXT_I2S)(const X509V3_EXT_METHOD* method, void* ext);
typedef void* (*X509V3_EXT_S2I)(const X509V3_EXT_METHOD* method, const X509V3_CTX* ctx,
                                const char* str);
typedef int (*X509V3_EXT_I2R)(const X509V3_EXT_METHOD* method, void* ext, BIO* out, int indent);
typedef void* (*X509V3_EXT_R2I)(const X509V3_EXT_METHOD* method, const X509V3_CTX* ctx,
                                const char* str);
...
OPENSSL_EXPORT OPENSSL_DEPRECATED int X509V3_EXT_add_alias(int nid_to, int nid_from);
...
OPENSSL_EXPORT void X509V3_set_ctx(X509V3_CTX* ctx, const X509* issuer, const X509* subject,
...
OPENSSL_EXPORT X509_EXTENSION* X509V3_EXT_nconf(const CONF* conf, const X509V3_CTX* ctx,
                                                const char* name, const char* value);

// X509V3_EXT_nconf_nid behaves like |X509V3_EXT_nconf|, except the extension
// type is specified as a NID.
OPENSSL_EXPORT X509_EXTENSION* X509V3_EXT_nconf_nid(const CONF* conf, const X509V3_CTX* ctx,
...
OPENSSL_EXPORT int X509V3_EXT_add_nconf_sk(const CONF* conf, const X509V3_CTX* ctx,
                                           const char* section, STACK_OF(X509_EXTENSION) * *sk);
...
// |X509V3_EXT_add_nconf_sk|. It returns one on success and zero on error.
OPENSSL_EXPORT int X509V3_EXT_REQ_add_nconf(const CONF* conf, const X509V3_CTX* ctx,
                                            const char* section, X509_REQ* req);

// X509V3_EXT_CRL_add_nconf adds extensions to |crl| as in
// |X509V3_EXT_add_nconf_sk|. It returns one on success and zero on error.
OPENSSL_EXPORT int X509V3_EXT_CRL_add_nconf(const CONF* conf, const X509V3_CTX* ctx,
...
// and |ctx| are ignored.
OPENSSL_EXPORT ASN1_OCTET_STRING* s2i_ASN1_OCTET_STRING(const X509V3_EXT_METHOD* method,
                                                        const X509V3_CTX* ctx, const char* str);

// i2s_ASN1_INTEGER returns a human-readable representation of |aint| as a
// newly-allocated, NUL-terminated string, or NULL on error. |method| is
// ignored. The caller must release the result with |OPENSSL_free| when done.
OPENSSL_EXPORT char* i2s_ASN1_INTEGER(const X509V3_EXT_METHOD* method, const ASN1_INTEGER* aint);
...
OPENSSL_EXPORT ASN1_INTEGER* s2i_ASN1_INTEGER(const X509V3_EXT_METHOD* method, const char* value);
...
OPENSSL_EXPORT STACK_OF(CONF_VALUE) * i2v_GENERAL_NAME(const X509V3_EXT_METHOD* method,
...
// human-readable print functions. If extracting a SAN list from a certificate,
// look at |gen| directly.
OPENSSL_EXPORT STACK_OF(CONF_VALUE) * i2v_GENERAL_NAMES(const X509V3_EXT_METHOD* method,
                                                        const GENERAL_NAMES* gen,
...
OPENSSL_EXPORT int X509_NAME_get_text_by_OBJ(const X509_NAME* name, const ASN1_OBJECT* obj,
                                             char* buf, int len);
...
OPENSSL_EXPORT X509_STORE_CTX* X509_STORE_CTX_get0_parent_ctx(const X509_STORE_CTX* ctx);
...
OPENSSL_EXPORT STACK_OF(X509) * X509_STORE_CTX_get_chain(const X509_STORE_CTX* ctx);
...
OPENSSL_EXPORT void X509_STORE_set_verify_cb(X509_STORE* store, X509_STORE_CTX_verify_cb verify_cb);

// X509_STORE_set_verify_cb_func is a deprecated alias for
// |X509_STORE_set_verify_cb|.
#define X509_STORE_set_verify_cb_func(store, func) X509_STORE_set_verify_cb((store), (func))
...
OPENSSL_EXPORT void X509_STORE_CTX_set_chain(X509_STORE_CTX* ctx, STACK_OF(X509) * sk);
...
OPENSSL_EXPORT STACK_OF(X509_OBJECT) * X509_STORE_get0_objects(X509_STORE* store);
