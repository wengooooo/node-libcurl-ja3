...
OPENSSL_EXPORT ASN1_VALUE* ASN1_item_d2i(ASN1_VALUE** out, const unsigned char** inp, long len,
                                         const ASN1_ITEM* it);
...
OPENSSL_EXPORT ASN1_BOOLEAN d2i_ASN1_BOOLEAN(ASN1_BOOLEAN* out, const unsigned char** inp,
                                             long len);
...
OPENSSL_EXPORT int ASN1_STRING_set(ASN1_STRING* str, const void* data, ossl_ssize_t len);
...
// |d2i_SAMPLE|.
OPENSSL_EXPORT ASN1_BMPSTRING* d2i_ASN1_BMPSTRING(ASN1_BMPSTRING** out, const uint8_t** inp,
                                                  long len);
OPENSSL_EXPORT ASN1_GENERALSTRING* d2i_ASN1_GENERALSTRING(ASN1_GENERALSTRING** out,
                                                          const uint8_t** inp, long len);
OPENSSL_EXPORT ASN1_IA5STRING* d2i_ASN1_IA5STRING(ASN1_IA5STRING** out, const uint8_t** inp,
                                                  long len);
...
OPENSSL_EXPORT ASN1_PRINTABLESTRING* d2i_ASN1_PRINTABLESTRING(ASN1_PRINTABLESTRING** out,
                                                              const uint8_t** inp, long len);
OPENSSL_EXPORT ASN1_T61STRING* d2i_ASN1_T61STRING(ASN1_T61STRING** out, const uint8_t** inp,
                                                  long len);
OPENSSL_EXPORT ASN1_UNIVERSALSTRING* d2i_ASN1_UNIVERSALSTRING(ASN1_UNIVERSALSTRING** out,
                                                              const uint8_t** inp, long len);
OPENSSL_EXPORT ASN1_UTF8STRING* d2i_ASN1_UTF8STRING(ASN1_UTF8STRING** out, const uint8_t** inp,
                                                    long len);
...
OPENSSL_EXPORT int ASN1_OCTET_STRING_set(ASN1_OCTET_STRING* str, const unsigned char* data,
                                         int len);
...
OPENSSL_EXPORT int ASN1_mbstring_copy(ASN1_STRING** out, const uint8_t* in, ossl_ssize_t len,
...
OPENSSL_EXPORT int ASN1_mbstring_ncopy(ASN1_STRING** out, const uint8_t* in, ossl_ssize_t len,
                                       int inform, unsigned long mask, ossl_ssize_t minsize,
...
OPENSSL_EXPORT ASN1_STRING* ASN1_STRING_set_by_NID(ASN1_STRING** out, const unsigned char* in,
...
OPENSSL_EXPORT int ASN1_STRING_TABLE_add(int nid, long minsize, long maxsize, unsigned long mask,
                                         unsigned long flags);
...
OPENSSL_EXPORT ASN1_BIT_STRING* d2i_ASN1_BIT_STRING(ASN1_BIT_STRING** out, const uint8_t** inp,
                                                    long len);
...
OPENSSL_EXPORT ASN1_BIT_STRING* c2i_ASN1_BIT_STRING(ASN1_BIT_STRING** out, const uint8_t** inp,
                                                    long len);
...
// common use case.
OPENSSL_EXPORT int ASN1_BIT_STRING_set(ASN1_BIT_STRING* str, const unsigned char* d,
                                       ossl_ssize_t length);
...
OPENSSL_EXPORT int ASN1_BIT_STRING_check(const ASN1_BIT_STRING* str, const unsigned char* flags,
                                         int flags_len);
...
OPENSSL_EXPORT ASN1_ENUMERATED* d2i_ASN1_ENUMERATED(ASN1_ENUMERATED** out, const uint8_t** inp,
                                                    long len);
...
OPENSSL_EXPORT ASN1_UTCTIME* ASN1_UTCTIME_set(ASN1_UTCTIME* s, int64_t posix_time);
...
// UTCTime.
OPENSSL_EXPORT ASN1_UTCTIME* ASN1_UTCTIME_adj(ASN1_UTCTIME* s, int64_t posix_time, int offset_day,
                                              long offset_sec);
...
// decoded.
OPENSSL_EXPORT int ASN1_TIME_diff(int* out_days, int* out_seconds, const ASN1_TIME* from,
                                  const ASN1_TIME* to);
...
// Note this function may fail if the time overflows or is out of range for
// GeneralizedTime.
OPENSSL_EXPORT ASN1_TIME* ASN1_TIME_adj(ASN1_TIME* s, int64_t posix_time, int offset_day,
                                        long offset_sec);
...
OPENSSL_EXPORT int ASN1_TIME_to_posix_nonstandard(const ASN1_TIME* t, int64_t* out);
...
OPENSSL_EXPORT ASN1_OBJECT* ASN1_OBJECT_create(int nid, const uint8_t* data, size_t len,
...
// TODO(https://crbug.com/boringssl/354): This function currently also accepts
// BER, but this will be removed in the future.
OPENSSL_EXPORT ASN1_SEQUENCE_ANY* d2i_ASN1_SET_ANY(ASN1_SEQUENCE_ANY** out, const uint8_t** inp,
                                                   long len);
...
OPENSSL_EXPORT int ASN1_get_object(const unsigned char** inp, long* out_length, int* out_tag,
                                   int* out_class, long max_len);
...
OPENSSL_EXPORT void ASN1_put_object(unsigned char** outp, int constructed, int length, int tag,
                                    int xclass);
