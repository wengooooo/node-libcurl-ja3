...
OPENSSL_EXPORT int MLDSA65_generate_key(uint8_t out_encoded_public_key[MLDSA65_PUBLIC_KEY_BYTES],
...
OPENSSL_EXPORT int MLDSA65_private_key_from_seed(struct MLDSA65_private_key* out_private_key,
...
OPENSSL_EXPORT int MLDSA65_public_from_private(struct MLDSA65_public_key* out_public_key,
...
OPENSSL_EXPORT int MLDSA65_sign(uint8_t out_encoded_signature[MLDSA65_SIGNATURE_BYTES],
...
// allocation error.
OPENSSL_EXPORT int MLDSA65_marshal_public_key(CBB* out,
...
OPENSSL_EXPORT int MLDSA65_parse_public_key(struct MLDSA65_public_key* public_key, CBS* in);
