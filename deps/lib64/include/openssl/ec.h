...
// error.
OPENSSL_EXPORT int EC_GROUP_get_curve_GFp(const EC_GROUP* group, BIGNUM* out_p, BIGNUM* out_a,
...
OPENSSL_EXPORT int EC_POINT_cmp(const EC_GROUP* group, const EC_POINT* a, const EC_POINT* b,
                                BN_CTX* ctx);
...
OPENSSL_EXPORT int EC_POINT_get_affine_coordinates_GFp(const EC_GROUP* group, const EC_POINT* point,
                                                       BIGNUM* x, BIGNUM* y, BN_CTX* ctx);

// EC_POINT_get_affine_coordinates is an alias of
// |EC_POINT_get_affine_coordinates_GFp|.
OPENSSL_EXPORT int EC_POINT_get_affine_coordinates(const EC_GROUP* group, const EC_POINT* point,
                                                   BIGNUM* x, BIGNUM* y, BN_CTX* ctx);
...
OPENSSL_EXPORT int EC_POINT_set_affine_coordinates_GFp(const EC_GROUP* group, EC_POINT* point,
                                                       const BIGNUM* x, const BIGNUM* y,
                                                       BN_CTX* ctx);

// EC_POINT_set_affine_coordinates is an alias of
// |EC_POINT_set_affine_coordinates_GFp|.
OPENSSL_EXPORT int EC_POINT_set_affine_coordinates(const EC_GROUP* group, EC_POINT* point,
...
OPENSSL_EXPORT size_t EC_POINT_point2oct(const EC_GROUP* group, const EC_POINT* point,
                                         point_conversion_form_t form, uint8_t* buf, size_t max_out,
                                         BN_CTX* ctx);
...
OPENSSL_EXPORT size_t EC_POINT_point2buf(const EC_GROUP* group, const EC_POINT* point,
...
OPENSSL_EXPORT int EC_POINT_oct2point(const EC_GROUP* group, EC_POINT* point, const uint8_t* buf,
...
OPENSSL_EXPORT int EC_POINT_set_compressed_coordinates_GFp(const EC_GROUP* group, EC_POINT* point,
...
OPENSSL_EXPORT int EC_POINT_add(const EC_GROUP* group, EC_POINT* r, const EC_POINT* a,
...
OPENSSL_EXPORT int EC_POINT_mul(const EC_GROUP* group, EC_POINT* r, const BIGNUM* n,
...
OPENSSL_EXPORT int EC_hash_to_curve_p256_xmd_sha256_sswu(const EC_GROUP* group, EC_POINT* out,
...
// from RFC 9380. It returns one on success and zero on error.
OPENSSL_EXPORT int EC_hash_to_curve_p384_xmd_sha384_sswu(const EC_GROUP* group, EC_POINT* out,
                                                         const uint8_t* dst, size_t dst_len,
                                                         const uint8_t* msg, size_t msg_len);
...
OPENSSL_EXPORT EC_GROUP* EC_GROUP_new_curve_GFp(const BIGNUM* p, const BIGNUM* a, const BIGNUM* b,
                                                BN_CTX* ctx);
...
OPENSSL_EXPORT int EC_GROUP_set_generator(EC_GROUP* group, const EC_POINT* generator,
