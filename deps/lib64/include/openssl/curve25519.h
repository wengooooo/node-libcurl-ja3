...
OPENSSL_EXPORT SPAKE2_CTX* SPAKE2_CTX_new(enum spake2_role_t my_role, const uint8_t* my_name,
...
OPENSSL_EXPORT int SPAKE2_generate_msg(SPAKE2_CTX* ctx, uint8_t* out, size_t* out_len,
...
OPENSSL_EXPORT int SPAKE2_process_msg(SPAKE2_CTX* ctx, uint8_t* out_key, size_t* out_key_len,
