...
OPENSSL_EXPORT int TRUST_TOKEN_generate_key(const TRUST_TOKEN_METHOD* method, uint8_t* out_priv_key,
                                            size_t* out_priv_key_len, size_t max_priv_key_len,
                                            uint8_t* out_pub_key, size_t* out_pub_key_len,
                                            size_t max_pub_key_len, uint32_t id);
...
OPENSSL_EXPORT int TRUST_TOKEN_derive_key_from_secret(
    const TRUST_TOKEN_METHOD* method, uint8_t* out_priv_key, size_t* out_priv_key_len,
    size_t max_priv_key_len, uint8_t* out_pub_key, size_t* out_pub_key_len, size_t max_pub_key_len,
    uint32_t id, const uint8_t* secret, size_t secret_len);
...
OPENSSL_EXPORT int TRUST_TOKEN_CLIENT_add_key(TRUST_TOKEN_CLIENT* ctx, size_t* out_key_index,
...
// zero on error.
OPENSSL_EXPORT int TRUST_TOKEN_CLIENT_begin_issuance(TRUST_TOKEN_CLIENT* ctx, uint8_t** out,
...
OPENSSL_EXPORT int TRUST_TOKEN_CLIENT_begin_issuance_over_message(TRUST_TOKEN_CLIENT* ctx,
                                                                  uint8_t** out, size_t* out_len,
                                                                  size_t count, const uint8_t* msg,
                                                                  size_t msg_len);
...
OPENSSL_EXPORT STACK_OF(TRUST_TOKEN) *
    TRUST_TOKEN_CLIENT_finish_issuance(TRUST_TOKEN_CLIENT* ctx, size_t* out_key_index,
...
OPENSSL_EXPORT int TRUST_TOKEN_CLIENT_begin_redemption(TRUST_TOKEN_CLIENT* ctx, uint8_t** out,
...
OPENSSL_EXPORT int TRUST_TOKEN_CLIENT_finish_redemption(TRUST_TOKEN_CLIENT* ctx, uint8_t** out_rr,
                                                        size_t* out_rr_len, uint8_t** out_sig,
                                                        size_t* out_sig_len,
...
OPENSSL_EXPORT int TRUST_TOKEN_ISSUER_add_key(TRUST_TOKEN_ISSUER* ctx, const uint8_t* key,
                                              size_t key_len);
...
// and zero on error.
OPENSSL_EXPORT int TRUST_TOKEN_ISSUER_set_metadata_key(TRUST_TOKEN_ISSUER* ctx, const uint8_t* key,
                                                       size_t len);
...
// error.
OPENSSL_EXPORT int TRUST_TOKEN_ISSUER_issue(const TRUST_TOKEN_ISSUER* ctx, uint8_t** out,
...
OPENSSL_EXPORT int TRUST_TOKEN_ISSUER_redeem(const TRUST_TOKEN_ISSUER* ctx, uint32_t* out_public,
                                             uint8_t* out_private, TRUST_TOKEN** out_token,
                                             uint8_t** out_client_data, size_t* out_client_data_len,
                                             const uint8_t* request, size_t request_len);
...
OPENSSL_EXPORT int TRUST_TOKEN_ISSUER_redeem_over_message(
    ...
    TRUST_TOKEN** out_token, uint8_t** out_client_data, size_t* out_client_data_len,
    const uint8_t* request, size_t request_len, const uint8_t* msg, size_t msg_len);
...
OPENSSL_EXPORT int TRUST_TOKEN_decode_private_metadata(const TRUST_TOKEN_METHOD* method,
                                                       ...
                                                       size_t nonce_len, uint8_t encrypted_bit);
