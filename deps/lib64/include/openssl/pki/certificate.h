...
class OPENSSL_EXPORT Certificate {
 public:
  ...
  static std::unique_ptr<Certificate> FromDER(bssl::Span<const uint8_t> der,
  ...
  static std::unique_ptr<Certificate> FromPEM(std::string_view pem, std::string* out_diagnostic);
