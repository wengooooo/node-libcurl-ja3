...
// caller.
OPENSSL_EXPORT X509_SIG* PKCS8_encrypt(int pbe_nid, const EVP_CIPHER* cipher, const char* pass,
...
OPENSSL_EXPORT int PKCS8_marshal_encrypted_private_key(CBB* out, int pbe_nid,
...
OPENSSL_EXPORT EVP_PKEY* PKCS8_parse_encrypted_private_key(CBS* cbs, const char* pass,
                                                           size_t pass_len);
...
OPENSSL_EXPORT int PKCS12_parse(const PKCS12* p12, const char* password, EVP_PKEY** out_pkey,
...
// parameter.
OPENSSL_EXPORT PKCS12* PKCS12_create(const char* password, const char* name, const EVP_PKEY* pkey,
