...
OPENSSL_EXPORT uint8_t* HMAC(const EVP_MD* evp_md, const void* key, size_t key_len,
...
// empty key.
OPENSSL_EXPORT int HMAC_Init_ex(HMAC_CTX* ctx, const void* key, size_t key_len, const EVP_MD* md,
                                ENGINE* impl);
