...
OPENSSL_EXPORT int EVP_HPKE_KEY_public_key(const EVP_HPKE_KEY* key, uint8_t* out, size_t* out_len,
                                           size_t max_out);
...
OPENSSL_EXPORT int EVP_HPKE_KEY_private_key(const EVP_HPKE_KEY* key, uint8_t* out, size_t* out_len,
                                            size_t max_out);
...
OPENSSL_EXPORT int EVP_HPKE_CTX_setup_sender(EVP_HPKE_CTX* ctx, uint8_t* out_enc,
...
OPENSSL_EXPORT int EVP_HPKE_CTX_setup_sender_with_seed_for_testing(
    ...
    const uint8_t* peer_public_key, size_t peer_public_key_len, const uint8_t* info,
    size_t info_len, const uint8_t* seed, size_t seed_len);
...
OPENSSL_EXPORT int EVP_HPKE_CTX_setup_recipient(EVP_HPKE_CTX* ctx, const EVP_HPKE_KEY* key,
...
// context with |key|.
OPENSSL_EXPORT int EVP_HPKE_CTX_setup_auth_sender(EVP_HPKE_CTX* ctx, uint8_t* out_enc,
                                                  size_t* out_enc_len, size_t max_enc,
...
OPENSSL_EXPORT int EVP_HPKE_CTX_setup_auth_recipient(
    EVP_HPKE_CTX* ctx, const EVP_HPKE_KEY* key, const EVP_HPKE_KDF* kdf, const EVP_HPKE_AEAD* aead,
...
OPENSSL_EXPORT int EVP_HPKE_CTX_open(EVP_HPKE_CTX* ctx, uint8_t* out, size_t* out_len,
...
OPENSSL_EXPORT int EVP_HPKE_CTX_seal(EVP_HPKE_CTX* ctx, uint8_t* out, size_t* out_len,
                                     size_t max_out_len, const uint8_t* in, size_t in_len,
                                     const uint8_t* ad, size_t ad_len);
...
OPENSSL_EXPORT int EVP_HPKE_CTX_export(const EVP_HPKE_CTX* ctx, uint8_t* out, size_t secret_len,
...
using ScopedEVP_HPKE_CTX =
    internal::StackAllocated<EVP_HPKE_CTX, void, EVP_HPKE_CTX_zero, EVP_HPKE_CTX_cleanup>;
using ScopedEVP_HPKE_KEY = internal::StackAllocatedMovable<EVP_HPKE_KEY, void, EVP_HPKE_KEY_zero,
