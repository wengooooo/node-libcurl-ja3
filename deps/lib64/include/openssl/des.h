...
OPENSSL_EXPORT void DES_ncbc_encrypt(const uint8_t* in, uint8_t* out, size_t len,
                                     const DES_key_schedule* schedule, DES_cblock* ivec, int enc);
...
OPENSSL_EXPORT void DES_ecb3_encrypt(const DES_cblock* input, DES_cblock* output,
...
OPENSSL_EXPORT void DES_ede3_cbc_encrypt(const uint8_t* in, uint8_t* out, size_t len,
                                         const DES_key_schedule* ks1, const DES_key_schedule* ks2,
...
OPENSSL_EXPORT void DES_ede2_cbc_encrypt(const uint8_t* in, uint8_t* out, size_t len,
                                         const DES_key_schedule* ks1, const DES_key_schedule* ks2,
...
OPENSSL_EXPORT void DES_ede3_cfb64_encrypt(const uint8_t* in, uint8_t* out, long length,
