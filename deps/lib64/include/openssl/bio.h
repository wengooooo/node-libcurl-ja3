...
// the operation.
typedef long (*bio_info_cb)(BIO* bio, int event, const char* parg, int cmd, long larg,
                            long return_value);
...
// error.
OPENSSL_EXPORT int BIO_meth_set_create(BIO_METHOD* method, int (*create_func)(BIO*));
...
OPENSSL_EXPORT int BIO_meth_set_destroy(BIO_METHOD* method, int (*destroy_func)(BIO*));
...
// returns one.
OPENSSL_EXPORT int BIO_meth_set_read(BIO_METHOD* method, int (*read_func)(BIO*, char*, int));

// BIO_meth_set_gets sets the implementation of |BIO_gets| for |method| and
// returns one.
OPENSSL_EXPORT int BIO_meth_set_gets(BIO_METHOD* method, int (*gets_func)(BIO*, char*, int));

// BIO_meth_set_ctrl sets the implementation of |BIO_ctrl| for |method| and
// returns one.
OPENSSL_EXPORT int BIO_meth_set_ctrl(BIO_METHOD* method, long (*ctrl_func)(BIO*, int, long, void*));
...
OPENSSL_EXPORT int BIO_get_ex_new_index(long argl, void* argp, CRYPTO_EX_unused* unused,
