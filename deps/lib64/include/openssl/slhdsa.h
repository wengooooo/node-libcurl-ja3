...
OPENSSL_EXPORT int SLHDSA_SHA2_128S_sign(
    ...
    const uint8_t private_key[SLHDSA_SHA2_128S_PRIVATE_KEY_BYTES], const uint8_t* msg,
...
OPENSSL_EXPORT int SLHDSA_SHA2_128S_verify(
    ...
    const uint8_t public_key[SLHDSA_SHA2_128S_PUBLIC_KEY_BYTES], const uint8_t* msg, size_t msg_len,
...
OPENSSL_EXPORT int SLHDSA_SHA2_128S_prehash_sign(
    uint8_t out_signature[SLHDSA_SHA2_128S_SIGNATURE_BYTES],
    const uint8_t private_key[SLHDSA_SHA2_128S_PRIVATE_KEY_BYTES], const uint8_t* hashed_msg,
    size_t hashed_msg_len, int hash_nid, const uint8_t* context, size_t context_len);
...
OPENSSL_EXPORT int SLHDSA_SHA2_128S_prehash_verify(
    const uint8_t* signature, size_t signature_len,
    const uint8_t public_key[SLHDSA_SHA2_128S_PUBLIC_KEY_BYTES], const uint8_t* hashed_msg,
    size_t hashed_msg_len, int hash_nid, const uint8_t* context, size_t context_len);
