...
#define ASN1_SEQUENCE_ref(tname, cb)                                                              \
  static const ASN1_AUX tname##_aux = {NULL, ASN1_AFLG_REFCOUNT, offsetof(tname, references), cb, \
                                       0};                                                        \
  ASN1_SEQUENCE(tname)
...
#define IMPLEMENT_ASN1_DUP_FUNCTION(stname) \
  stname* stname##_dup(stname* x) { return (stname*)ASN1_item_dup(ASN1_ITEM_rptr(stname), x); }
