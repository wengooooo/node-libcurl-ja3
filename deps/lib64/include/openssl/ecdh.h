...
OPENSSL_EXPORT int ECDH_compute_key(void* out, size_t outlen, const EC_POINT* pub_key,
...
OPENSSL_EXPORT int ECDH_compute_key_fips(uint8_t* out, size_t out_len, const EC_POINT* pub_key,
                                         const EC_KEY* priv_key);
