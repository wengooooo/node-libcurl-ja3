...
OPENSSL_EXPORT void MLKEM768_generate_key(uint8_t out_encoded_public_key[MLKEM768_PUBLIC_KEY_BYTES],
...
OPENSSL_EXPORT int MLKEM768_private_key_from_seed(struct MLKEM768_private_key* out_private_key,
...
OPENSSL_EXPORT void MLKEM768_public_from_private(struct MLKEM768_public_key* out_public_key,
...
// |out_shared_secret|.
OPENSSL_EXPORT void MLKEM768_encap(uint8_t out_ciphertext[MLKEM768_CIPHERTEXT_BYTES],
...
OPENSSL_EXPORT int MLKEM768_decap(uint8_t out_shared_secret[MLKEM_SHARED_SECRET_BYTES],
...
// allocation error.
OPENSSL_EXPORT int MLKEM768_marshal_public_key(CBB* out,
                                               const struct MLKEM768_public_key* public_key);
...
OPENSSL_EXPORT int MLKEM768_parse_public_key(struct MLKEM768_public_key* out_public_key, CBS* in);
...
OPENSSL_EXPORT void MLKEM1024_generate_key(
    ...
    uint8_t optional_out_seed[MLKEM_SEED_BYTES], struct MLKEM1024_private_key* out_private_key);
...
OPENSSL_EXPORT int MLKEM1024_private_key_from_seed(struct MLKEM1024_private_key* out_private_key,
                                                   const uint8_t* seed, size_t seed_len);
...
OPENSSL_EXPORT void MLKEM1024_public_from_private(struct MLKEM1024_public_key* out_public_key,
...
// ciphertext to |out_ciphertext|, and writes the random shared secret to
// |out_shared_secret|.
OPENSSL_EXPORT void MLKEM1024_encap(uint8_t out_ciphertext[MLKEM1024_CIPHERTEXT_BYTES],
                                    uint8_t out_shared_secret[MLKEM_SHARED_SECRET_BYTES],
...
OPENSSL_EXPORT int MLKEM1024_decap(uint8_t out_shared_secret[MLKEM_SHARED_SECRET_BYTES],
                                   const uint8_t* ciphertext, size_t ciphertext_len,
                                   const struct MLKEM1024_private_key* private_key);
...
// allocation error.
OPENSSL_EXPORT int MLKEM1024_marshal_public_key(CBB* out,
                                                const struct MLKEM1024_public_key* public_key);
...
// |out_public_key|. It returns one on success or zero on parse error or if
// there are trailing bytes in |in|.
OPENSSL_EXPORT int MLKEM1024_parse_public_key(struct MLKEM1024_public_key* out_public_key, CBS* in);
