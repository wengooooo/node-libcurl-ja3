...
#define CURL_EXTERN
#elif defined(_WIN32) || \
    (CURL_HAS_DECLSPEC_ATTRIBUTE(dllexport) && CURL_HAS_DECLSPEC_ATTRIBUTE(dllimport))
...
#define CURLOPT_PROGRESSDATA CURLOPT_XFERINFODATA
  ...
  */
  ...
  CURLOPTDEPRECATED(CURLOPT_SSL_FALSESTART, CURLOPTTYPE_LONG, 233, 8.15.0, "Has no function"),
...
#define CURL_IPRESOLVE_WHATEVER                                   \
  0L                         /* default, uses addresses to all IP \
...
#define CURL_HTTP_VERSION_NONE                                               \
  0L                             /* setting this means we do not care, and   \
...
#define CURL_HTTP_VERSION_2TLS                   \
  4L /* use version 2 for HTTPS, version 1.1 for \
        HTTP */
#define CURL_HTTP_VERSION_2_PRIOR_KNOWLEDGE \
  5L /* please use HTTP 2 without           \
        HTTP/1.1 Upgrade */
#define CURL_HTTP_VERSION_3                    \
  30L /* Use HTTP/3, fallback to HTTP/2 or     \
         HTTP/1 if needed. For HTTPS only. For \
         HTTP, this option makes libcurl       \
         return error. */
#define CURL_HTTP_VERSION_3ONLY                                        \
  31L                              /* Use HTTP/3 without fallback. For \
...
#define CURL_NETRC_IGNORED             \
  0L /* The .netrc will never be read. \
        This is the default. */
#define CURL_NETRC_OPTIONAL                          \
  1L /* A user:password in the URL will be preferred \
        to one in the .netrc. */
#define CURL_NETRC_REQUIRED                         \
  2L /* A user:password in the URL will be ignored. \
